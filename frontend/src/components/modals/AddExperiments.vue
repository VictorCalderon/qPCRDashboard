    ...
    <b-overlay :show="loading">
      ...
      >
        ...
        <b-container>
          <b-row>
            <b-col>
              <b-button @click="uploadExperiment" variant="outline-success" block>Upload Experiment</b-button>
            </b-col>
            <b-col>
...
export default {
  methods: {
    ...
    async uploadExperiment() {
      ...
      // this.$store.dispatch("loadLastExperiment");
      // }, 1500);
    }
  },
  ...
  data() {
    return {
      ...
      name: "",
      nameDescription:
        "The title should contain enough information to be distinguishable from other experiments",
      methodDescription:
