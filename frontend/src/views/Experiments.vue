...
<script>
import AmpPlot from "@/components/experiments/AmpPlot";
import SampleTable from "@/components/experiments/SampleTable";
import PCAKMeans from "@/components/experiments/PCAKMeans";
import MaxGrad from "@/components/experiments/MaxGrad";
